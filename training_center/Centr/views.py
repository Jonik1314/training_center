...
from Centr.models import MenuTrainingCent, RecordForm, more_detailed
...
def detailed(request, object_id):  # object_id принимает id из URL
    detail = get_object_or_404(MenuTrainingCent, pk=object_id)  # получаем объект
    context = {'detail': detail}
    return render(request, 'more_detailed.html', context)
